...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--use_vae', type=bool, default=True, help='# of input image channels')
        self.parser.add_argument('--z_dim', type=int, default=256, help='# of input image channels')
        ...
        self.parser.add_argument('--G_n_upampling', type=int, default=5, help='up-sampling blocks for generator')
        self.parser.add_argument('--D_n_downsampling', type=int, default=2, help='down-sampling blocks for discriminator')

        self.parser.add_argument('--crop_radius', type=int, default=20, help='use cxloss or not')
        self.parser.add_argument('--content_weight', type=float, default=0, help='weight of content')
