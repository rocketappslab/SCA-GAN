...
# train
img_dir  = 'fashion_data/train' #raw image path
annotations_file = 'fashion_data/fashion-resize-annotation-train.csv' #pose annotation path
save_path = 'fashion_data/trainK' #path to store pose maps
compute_pose(img_dir, annotations_file, save_path)

# test
img_dir  = 'fashion_data/test' #raw image path
